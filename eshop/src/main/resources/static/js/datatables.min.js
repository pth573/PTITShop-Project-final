...
(function (h) {
  ...
  n.defaults = {
    ...
    oLanguage: {
      ...
      sInfo: "Hiện từ _START_ tới _END_ của _TOTAL_ bộ dữ liệu",
      sInfoEmpty: "Hiện từ 0 tới 0 của 0 bộ dữ liệu",
      sInfoFiltered: "(lọc từ _MAX_ total entries)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Hiện _MENU_ bộ dữ liệu",
      sLoadingRecords: "Đang tải...",
      sProcessing: "Đang xử lý...",
      sSearch: "Tìm kiếm:",
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "Không tìm thấy bản ghi",
    },
