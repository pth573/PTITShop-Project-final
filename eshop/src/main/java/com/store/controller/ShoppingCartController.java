...
public class ShoppingCartController {
    ...
    public String addItem(@ModelAttribute("article") Article article, @RequestParam("qty") String qty,
                          @RequestParam("color") String color, RedirectAttributes attributes, Model model, Authentication authentication) {
        ...
        User user = (User) authentication.getPrincipal();
        shoppingCartService.addArticleToShoppingCart(article, user, Integer.parseInt(qty), color);
