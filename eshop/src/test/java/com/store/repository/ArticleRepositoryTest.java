...
public class ArticleRepositoryTest {
	...
	public void setUp() {
		Article article = new ArticleBuilder()
				.withTitle("article1")
				.withPrice(50)
				.color(Arrays.asList("38","39"))
				.ofCategories(Arrays.asList("running"))
				.ofType(Arrays.asList("nike"))
				.build();	
        ...
        Article article3 = new ArticleBuilder()
				.withTitle("article3")
				.withPrice(200)
				.color(Arrays.asList("39", "45", "43"))
				.ofCategories(Arrays.asList("sneaker"))
				.ofType(Arrays.asList("adidas"))
				.build();     
        entityManager.persist(article3); 
        
        Article article4 = new ArticleBuilder()
				.withTitle("article4")
				.color(Arrays.asList("45", "38"))
				.ofType(Arrays.asList("puma"))
				.withPrice(300)
				.build();     
	...
	@Test
	public void should_find_all_distinct_colors() {
        assertThat(repository.findAllColors()).hasSize(5).contains("38","39","40","43","45");
	}
	
	@Test
	public void should_find_all_distinct_types() {
        assertThat(repository.findAllTypes()).hasSize(3).contains("nike", "adidas", "puma");
	}
	...
	@Test
	public void should_filter_articles_by_type() {
