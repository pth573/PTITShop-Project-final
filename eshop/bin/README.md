# Spring-eshop
Traditional server rendered e-commerce store built on Spring Framework for learning purposes. [Live demo here](https://Colors.herokuapp.com)
...
* Store: display all products, filter products by price, category, size or type, order results by different criteria or filter by search input.
